        ...
        <div class="mb-4 col-span-full xl:mb-2">
            ...
            <div class="items-center justify-between block sm:flex">
                <div class="flex items-center mb-4 sm:mb-0">
                    <h1 class="text-xl font-semibold text-gray-900 sm:text-2xl dark:text-white">Details Mini Project</h1>
                </div>
                <div class="flex items-center space-x-4">
                    <a href="{{ route('mini-projects.edit', $mini_project->id) }}" id="updateProductButton"
                        ...
                        <div class="relative w-full h-full max-w-md md:h-auto">
                            <div class="relative bg-white rounded-lg shadow dark:bg-gray-700">
                                ...
                                <div class="p-6 text-center">
                                    ...
                                    <form action="{{ route('mini-projects.destroy', $mini_project->id) }}" method="POST"
                                        class="inline-flex">
                                        @method('delete')
                                        @csrf
                                        <button type="submit"
                ...
                <div class="grid grid-cols-6 gap-3">
                    ...
                    <div class="col-span-6">
                        <label for="id" class="block mb-2 text-sm font-medium text-gray-900 dark:text-white">Work
                            ID</label>
                        <input type="text" id="disabled-input-2 id" value="{{ $mini_project->id }}" name="id"
                    ...
                    <div class="col-span-6">
                        ...
                        <input type="text" id="disabled-input-2 project_name"
                            value="{{ $mini_project->project_name }}" name="project_name" aria-label="disabled input 2"
                            class="bg-gray-100 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full p-2.5  dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-gray-400 dark:focus:ring-blue-500 dark:focus:border-blue-500"
                            disabled readonly>
                    </div>
                    {{-- Slug --}}
                    <div class="col-span-6">
                        ...
                        <input type="text" id="disabled-input-2 slug" value="{{ $mini_project->slug }}"
                            name="slug" aria-label="disabled input 2"
                            class="bg-gray-100 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full p-2.5  dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-gray-400 dark:focus:ring-blue-500 dark:focus:border-blue-500"
                            disabled readonly>
                    </div>
                    ...
                    <div class="col-span-6">
                        ...
                        <input type="text" id="disabled-input-2 url" value="{{ $mini_project->url }}" name="url"
                            aria-label="disabled input 2"
                            class="bg-gray-100 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full p-2.5  dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-gray-400 dark:focus:ring-blue-500 dark:focus:border-blue-500"
                            disabled readonly>
                    ...
                    <div class="col-span-6">
                        ...
                        <input type="text" id="disabled-input-2 service"
                            value="{{ $mini_project->mini_project_tag->name }}" name="service"
                            aria-label="disabled input 2"
                            class="bg-gray-100 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full p-2.5  dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-gray-400 dark:focus:ring-blue-500 dark:focus:border-blue-500"
                            disabled readonly>
                    </div>
                    ...
                    <div class="col-span-6">
                        ...
                        <ul
                            ...
                            @foreach ($mini_project->tech_stacks as $tech_stack)
                                <li
                    ...
                    <div class="col-span-6 sm:col-span-full">
                        ...
                        <textarea id="overview" name="overview" rows="8" disabled
                            ...
                            placeholder="Write your thoughts here...">{{ $mini_project->overview }}</textarea>
                    </div>
                </div>
            </div>
            <div
