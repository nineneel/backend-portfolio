        ...
        <div class="col-span-2">
            <div
                ...
                <form action="{{ route('services.update', $service->id) }}" method="post" enctype="multipart/form-data">
                    @method('put')
                    @csrf
                    <input type="hidden" name="work_id" value="{{ $service->id }}">
                    <div class="grid grid-cols-6 gap-6">
                        ...
                        <div class="col-span-6 sm:col-span-full">
                            ...
                            <textarea id="description" name="description" rows="10"
                                ...
                                placeholder="Write your thoughts here...">{{ old('description', $service->description) }}</textarea>
                            @error('description')
                                <p class="mt-2 text-sm text-red-600 dark:text-red-500">{{ $message }}</p>
                            @enderror
                        </div>
                                ...
                                <div id="thumbnail-preview"
                                    ...
                                    <div id="thumbnail-preview-container"
                                        ...
                                        <img src="{{ asset($service->thumbnail) }}"
                                            alt="{{ $service->project_name }} thumbnail" class="h-56">
                                    </div>
...
@section('script')
    <script>
        ...
        name.addEventListener('change', function() {
            fetch(`/admin/service/create-slug?title=${name.value}`)
