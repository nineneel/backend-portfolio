        ...
        <div class="mb-4 col-span-full xl:mb-2">
                    ...
                    <li>
                        <div class="flex items-center">
                            ...
                            <a href="{{ route('services.index') }}"
                                class="ml-1 text-gray-700 hover:text-primary-600 md:ml-2 dark:text-gray-300 dark:hover:text-white">Services</a>
                        </div>
                    </li>
                    <li>
                        <div class="flex items-center">
            ...
            <div class="items-center justify-between block sm:flex">
                <div class="flex items-center mb-4 sm:mb-0">
                    <h1 class="text-xl font-semibold text-gray-900 sm:text-2xl dark:text-white">Details Services</h1>
                </div>
                <div class="flex items-center space-x-4">
                    <a href="{{ route('services.edit', $service->id) }}" id="updateProductButton"
                ...
                <div class="grid grid-cols-6 gap-3">
                    ...
                    <div class="col-span-6">
                        <label for="id" class="block mb-2 text-sm font-medium text-gray-900 dark:text-white">Service
                            ID</label>
                        <input type="text" id="disabled-input-2 id" value="{{ $service->id }}" name="id"
                    ...
                    <div class="col-span-6">
                        ...
                        <input type="text" id="disabled-input-2 name" value="{{ $service->name }}" name="name"
                            aria-label="disabled input 2"
                            class="bg-gray-100 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full p-2.5  dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-gray-400 dark:focus:ring-blue-500 dark:focus:border-blue-500"
                            disabled readonly>
                    </div>
                    ...
                    <div class="col-span-6">
                        ...
                        <input type="text" id="disabled-input-2 slug" value="{{ $service->slug }}" name="slug"
                            aria-label="disabled input 2"
                            class="bg-gray-100 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full p-2.5  dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-gray-400 dark:focus:ring-blue-500 dark:focus:border-blue-500"
                            disabled readonly>
                    </div>
                    ...
                    <div class="col-span-6 sm:col-span-full">
                        ...
                        <textarea id="description" name="description" rows="8" disabled
                            ...
                            placeholder="Write your thoughts here...">{{ $service->description }}</textarea>
                    </div>
                </div>
            </div>
            <div
                        ...
                        <div class="flex flex-col items-center justify-center w-full">
                            <div id="image-preview"
                                ...
                                <div id="image-preview-container"
                                    ...
                                    <img src="{{ asset($service->thumbnail) }}" alt="{{ $service->name }} thumbnail"
                                        class="h-56">
                                </div>
                            </div>
                        </div>
