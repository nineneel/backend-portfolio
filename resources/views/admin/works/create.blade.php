    ...
    <div class="grid grid-cols-1 px-4 pt-6 xl:gap-4 dark:bg-gray-900">
        ...
        <div class="col-span-2">
            <div
                ...
                <h3 class="mb-4 text-xl font-semibold dark:text-white">Work Information</h3>
                    ...
                    <div class="grid grid-cols-6 gap-6">
                        ...
                        <div class="col-span-6 sm:col-span-3">
                            ...
                            <label class="relative inline-flex items-center mt-3 cursor-pointer">
                                ...
                                <span class="ml-3 text-sm font-medium text-gray-900 dark:text-gray-300">Edit Slug</span>
                            </label>
                        </div>
                        {{-- Agency --}}
                        ...
                        <div class="col-span-6 sm:col-span-2">
                            ...
                            <input type="text" name="url" id="url" required placeholder="https://nineneel.com"
