<footer
    ...
    <ul class="flex flex-wrap items-center mb-6 space-y-1 md:mb-0">
        <li><a href="#"
                class="mr-4 text-sm font-normal text-gray-500 hover:underline md:mr-6 dark:text-gray-400">Home</a></li>
        <li>
    </ul>
...
<p class="my-10 text-sm text-center text-gray-500">
    &copy;2023 <a href="" class="hover:underline" target="_blank">nineneel.com</a> All rights
    reserved.
</p>
