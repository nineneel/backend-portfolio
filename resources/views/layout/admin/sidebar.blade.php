            ...
            <div class="flex-1 px-3 space-y-1 bg-white divide-y divide-gray-200 dark:bg-gray-800 dark:divide-gray-700">
                <ul class="pb-2 space-y-2">
                    ...
                    <li>
                        <button type="button"
                            ...
                            <span class="flex-1 ml-3 text-left whitespace-nowrap" sidebar-toggle-item>Works</span>
                    ...
                    <li>
                        <button type="button"
                            class="flex items-center w-full p-2 text-base text-gray-900 transition duration-75 rounded-lg group hover:bg-gray-100 dark:text-gray-200 dark:hover:bg-gray-700"
                            aria-controls="dropdown-mini-projects" data-collapse-toggle="dropdown-mini-projects">
                            <svg class="flex-shrink-0 w-6 h-6 text-gray-500 transition duration-75 group-hover:text-gray-900 dark:text-gray-400 dark:group-hover:text-white"
                            ...
                            <span class="flex-1 ml-3 text-left whitespace-nowrap" sidebar-toggle-item>Mini
                                Projects</span>
                            <svg sidebar-toggle-item class="w-6 h-6" fill="currentColor" viewBox="0 0 20 20"
                                xmlns="http://www.w3.org/2000/svg">
                                <path fill-rule="evenodd"
                    ...
                    <li>
                        <button type="button"
                            class="flex items-center w-full p-2 text-base text-gray-900 transition duration-75 rounded-lg group hover:bg-gray-100 dark:text-gray-200 dark:hover:bg-gray-700"
                            aria-controls="dropdown-collection" data-collapse-toggle="dropdown-collection">
                            <svg class="flex-shrink-0 w-6 h-6 text-gray-500 transition duration-75 group-hover:text-gray-900 dark:text-gray-400 dark:group-hover:text-white"
                                fill="currentColor" viewBox="0 0 576 512" xmlns="http://www.w3.org/2000/svg"
                                aria-hidden="true">
                                <path
                            ...
                            <span class="flex-1 ml-3 text-left whitespace-nowrap" sidebar-toggle-item>Collections</span>
                            <svg sidebar-toggle-item class="w-6 h-6" fill="currentColor" viewBox="0 0 20 20"
                                xmlns="http://www.w3.org/2000/svg">
                                <path fill-rule="evenodd"
                                    d="M5.293 7.293a1 1 0 011.414 0L10 10.586l3.293-3.293a1 1 0 111.414 1.414l-4 4a1 1 0 01-1.414 0l-4-4a1 1 0 010-1.414z"
                    ...
                    <li>
                        <button type="button"
                            class="flex items-center w-full p-2 text-base text-gray-900 transition duration-75 rounded-lg group hover:bg-gray-100 dark:text-gray-200 dark:hover:bg-gray-700"
                            aria-controls="dropdown-tech-stack" data-collapse-toggle="dropdown-tech-stack">
                            ...
                            <span class="flex-1 ml-3 text-left whitespace-nowrap" sidebar-toggle-item>Tech Stack</span>
                            <svg sidebar-toggle-item class="w-6 h-6" fill="currentColor" viewBox="0 0 20 20"
                                xmlns="http://www.w3.org/2000/svg">
                                <path fill-rule="evenodd"
                                    d="M5.293 7.293a1 1 0 011.414 0L10 10.586l3.293-3.293a1 1 0 111.414 1.414l-4 4a1 1 0 01-1.414 0l-4-4a1 1 0 010-1.414z"
                        ...
                        <ul id="dropdown-tech-stack" class="hidden py-2 space-y-2">
                            <li>
                                <a href="{{ 'layouts/stacked/' }}"
                                    class="flex items-center p-2 text-base text-gray-900 transition duration-75 rounded-lg pl-11 group hover:bg-gray-100 dark:text-gray-200 dark:hover:bg-gray-700">Stacked</a>
                            </li>
                ...
                <div class="pt-2 space-y-2">
                    <form action="{{ route('admin_logout') }}" method="post">
                        @csrf
                        <button type="submit"
                            class="w-full flex items-center p-2 text-base text-gray-900 transition duration-75 rounded-lg cursor-pointer hover:bg-gray-100 group dark:text-gray-200 dark:hover:bg-gray-700">
                            <svg class=" text-gray-500 w-6 h-6 dark:text-gray-400" fill="currentColor"
                                stroke="currentColor" viewBox="0 0 512 512" xmlns="http://www.w3.org/2000/svg">
                                <path
